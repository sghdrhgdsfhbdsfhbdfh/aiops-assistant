...
from app.utils.uploads import parse_allowed_extensions
...
class VectorIndexService:
    ...
    def __init__(self):
        ...
        self.allowed_extensions = parse_allowed_extensions(config.upload_allowed_extensions)
    ...
    def index_directory(self, directory_path: Optional[str] = None) -> IndexingResult:
        ...
        try:
            ...
            files = [
                ...
                and file_path.suffix.lower().lstrip(".") in self.allowed_extensions
            ]
